<script setup>
  ...
  import { useTheemeStore } from '@/stores/theme'
  const store_theme = useTheemeStore();
  const { changeMode } = store_theme
      ...
      <div class="relative -mx-4 flex items-center justify-between">
        ...
        <div class="w-60 max-w-full px-4">
          <a href="index.html" class="navbar-logo block w-full py-5">
            ...
            <div class="flex flex-row  logollpyoi-dark" id="logos_dark" v-if="store_theme.mode_dark">
              <div class="logo-fm">
                <LogosLiliPinkLigth/>
              </div>
              <div class="logo-llp dark-ii">
                &
              </div>
              <div class="logo-fm dark-yoi" >
                <LogosYoiLigth/>
              </div>
            </div>

            <div class="flex flex-row logollpyoi-ligth " id="logos_ligte" v-if="!store_theme.mode_dark">
              <div class="logo-fm llp">
                <img src="assets/website/lilipink/logo_llp_ligth.svg" alt="logo" style="width: 74px; height: 25px;" />
              </div>
              <div class="logo-llp ii">
                &
              </div>
              <div class="logo-fm yoi" >
                <img src="assets/website/lilipink/logo_yoi_ligth.svg" alt="logo" class=" w-full" style="width: 42.7px;height:26px; "  />
              </div>
            </div>
        ...
        <div class="flex w-full items-center justify-between px-4">
          ...
          <div class="flex items-center justify-end pr-16 lg:pr-0">
            ...
            >
              ...
              <span class="block text-white dark:hidden" @click="modeDark()">
                <svg
                  class="fill-current"
                  width="24"
                  height="24"
              ...
              <span class="hidden text-white dark:block" @click="modeDark()">
                <svg
                  class="fill-current"
                  width="24"
                  height="24"
            ...
            <div class="hidden sm:flex">
              ...
              >
                ...
                <!-- <font-awesome-icon icon="fa-regular fa-user-circle" size="2x" /> -->
                Ingresar
              </a>
              <a
                href="signup.html"
