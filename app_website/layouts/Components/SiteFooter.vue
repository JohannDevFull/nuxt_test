  ...
  <footer class="wow fadeInUp relative z-10 bg-[#090E34] pt-20 lg:pt-[100px]" data-wow-delay=".15s">
      ...
      <div class="-mx-4 flex flex-wrap">
        <div class="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-4/12 xl:w-3/12">
          <div class="mb-10 w-full">
            ...
            >
              <img
                src="assets/website/images/logo/logo-white.svg"
                alt="logo"
                class="max-w-full"
              />
            </a>
            ...
            <div class="flex flex-col gap-8">
              ...
              >
                <div class="overflow-hidden rounded">
                  <img
                    src="assets/website/images/blog/blog-footer-01.jpg"
                    alt="blog"
                  />
                </div>
                <span
              ...
              >
                <div class="overflow-hidden rounded">
                  <img
                    src="assets/website/images/blog/blog-footer-02.jpg"
                    alt="blog"
                  />
                </div>
                <span
    ...
    <div>
      <span class="absolute left-0 top-0 z-[-1]">
        <img src="assets/website/images/footer/shape-1.svg" alt="" />
      </span>

      <span class="absolute bottom-0 right-0 z-[-1]">
        <img src="assets/website/images/footer/shape-3.svg" alt="" />
      </span>
